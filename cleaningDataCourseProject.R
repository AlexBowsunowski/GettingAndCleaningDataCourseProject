setwd("/home/aleksandr/Documents/Rprojects/cleaningData/UCI_HAR_Dataset")
directory <- "/home/aleksandr/Documents/Rprojects/cleaningData/UCI_HAR_Dataset" 
pathdata <- file.path(directory)
#read data
...
#Rename the name of the data column
